# Graph Report - lilac-landing-v2  (2026-07-14)

## Corpus Check
- 46 files · ~1,145,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 266 nodes · 419 edges · 17 communities (14 shown, 3 thin omitted)
...
Cohesion: 0.11
Nodes (26): AboutEditorial(), ParallaxPhoto(), Amenities(), CountUp(), ICONS, BookSection(), ICONS, Experience() (+18 more)
...
Cohesion: 0.14
Nodes (12): dmSans, fraunces, metadata, nunito, playfair, EDITABLE_TAGS, editableFrom(), EditMode() (+4 more)
...
Cohesion: 0.12
Nodes (10): enterEase, GalleryNoir(), moveEase, ConciergeStay(), DETAILS, FIELDS, ROOMS, RoomsFilm() (+2 more)
...
## Knowledge Gaps
- **117 isolated node(s):** `FILE`, `Room`, `Photo`, `Content`, `JsonValue` (+112 more)
